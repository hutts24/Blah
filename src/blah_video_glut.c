...
bool blah_video_glut_initialised = false;  //state flag
...
void blah_video_glut_init() {  //Use crappy glut for now
	...
	blah_video_glut_initialised = true;  //set state flag on
}

void blah_video_glut_exit() { //Shutdown GLUT video component
	blah_video_glut_initialised = false;  //set state flag off
}
